...
<div class="k-hero">
  <div class="k-hero-inner">
    <div class="k-hero-text">
      ...
      <p class="k-lede">I turn messy, real-world data into things people can actually decide with <strong>spatial models</strong> of the LA office market, <strong>pricing analysis</strong> across four states, <strong>nonparametric tests</strong> on twenty years of policy data. Mostly in R, always reproducible.</p>
      <div class="k-buttons">
